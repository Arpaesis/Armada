 ...
 * @author Arpaesis
 *
 * @param <T> The type of object that will be expected as a parameter in the
 *        execute methods of the command.
 * @param <R> The return type that the execution methods will expect.
 */
public abstract class Command<T, R> {
     ...
     * 
     * @param obj The generic object passed into the execute method.
     * @param in  The arguments that were fed to the command prior to execution.
     ...
     * 
     * @param obj The generic object passed in.
     * @param in  The raw input given to the command for processing.
    ...
    /**
     * Sets the primary name for the command. This will be the default name the
     * command has during execution.
     * 
     ...
     * 
     * @param help The message to be displayed when referencing this command's help.
     */
    ...
    /**
     * @return A String array of the different names this command is associated
     *         with.
     */
    ...
    /**
     * Sets the aliases for this command to have. Aliases are optional names that
     * can be used in place of this command's primary name.
     * 
     * @param aliases The String array of aliases the command will use.
     */
    ...
    /**
     * Sets the cooldown in seconds for the command. The command will not execute
     * until the cooldown is over.
     * 
     * @param cooldown The number of seconds this command should wait until
     *                 executing again.
     */
    ...
    /**
     * Called at the end of a command's execution, signaling whether or not the
     * command failed.
     * 
     * @param obj      The generic object that was used in the execute method.
     * @param result   The result of the command's execution.
     * @param response A detailed response message about what went wrong with the
     *                 execution.
     */
     ...
     * 
     * @param obj      The object used in the command's execution.
     * @param result   The result of the command's execution.
     * @param response A detailed response message about what went wrong with the
     *                 execution.
     */
    ...
    /**
     * Sets the maximum number of times this command can be executed. Every usage of
     * the command contributes towards reaching this value. If this value is
     * reached, the command will cease to execute. By default, command's max usages
     * are set to -1.
     * 
     * @param maxUsage The maximum amount of times this command will be usable for.
     */
    ...
    /**
     * Sets the level of access this command requires. Typically, a higher value
     * means the command is more dangerous to use.
     * 
     * @param level The access level to set for the command.
     */
     ...
     * 
     * @param obj   The custom object with the specified type in the command.
     * @param input The input fed from the {@link CommandManager}.
    ...
    /**
     * Sets whether or not the command is disabled. Disabled commands can not be
     * executed.
     * 
     * @param isDisabled Whether or not the command is disabled.
     */
    ...
    /**
     * Allows for callbacks in command execution (also known as a
     * {@link CommandResponse}).
     * 
     * @param response The response the command should execute.
     */
