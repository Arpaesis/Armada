...
public abstract class Argument implements Comparable<Argument> {
    ...
    /**
     * Sets the range of the argument, if it is numeric. For Strings, this will set
     * the maximum length the String can be.
     * 
     * @param min The minimum value the number can be.
     * @param max The maximum value the number can be, or the maximum length the
     *            String can be.
    ...
    /**
     * @return The parent name of the argument that contains this argument, if this
     *         argument is nested. May return null.
     */
     ...
     * 
     * @param position The position of the argument within the raw argument input.
     * @return The argument.
     */
