...
public class SpawnEntityCommand extends Command<String, String>
{
	...
	public SpawnEntityCommand()
	{
		...
		this.addArgument(
				new OrArgument(new GroupArgument("coords", new RequiredArgument("xPos", ParamType.INT), new RequiredArgument("yPos", ParamType.INT), new RequiredArgument("zPos", ParamType.INT)),
