...
public class BalanceCommand extends Command<String, String> {
	...
	this.addArgument(new OrArgument(new RequiredArgument("single", ParamType.STRING), new GroupArgument("multi",
		new RequiredArgument("func", ParamType.STRING), new RequiredArgument("value", ParamType.INT))));
    }
