...
public class ProcessedGroupArgument extends ProcessedArgument<Object>
{
	...
	/**
	 * @return The collection of {@link ProcessedArgument}s within the processed group argument.
	 */
	...
	/**
	 * Fetches a boolean argument in the processed group argument with the given tag.
	 * 
	 * @param tag
	...
	/**
	 * Sets the @{link ProcessedArgument} of the processed group argument to the specified values.
	 * 
	 * @param values
	 *            The processed arguments to be put into the processed group argument.
	 */
